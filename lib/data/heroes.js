...
async function fetchHeroesFromSF() {
  ...
  return records.map((r) => ({
    ...
    familyContactName: r.Associated_Family_Contact__r?.Name || null,
    familyContactEmail: r.Associated_Family_Contact__r?.Email || null,
...
export async function getAnniversariesByMonth(month) {
  ...
  return heroes.filter((h) => Number(h.anniversaryMonth) === m);
}
