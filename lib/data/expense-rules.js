...
export const CATEGORIZATION_RULES = [
  ...
  // ── Charitable Disbursements ──
  { pattern: /HOPE\*?\s*DONATION|HEROESHOPE/i, category: "Charitable Disbursements", vendor: "Heroes Hope" },
  { pattern: /TRAVISMANION|TRAVIS\s*MANION/i, category: "Charitable Disbursements", vendor: "Travis Manion Foundation" },
  { pattern: /USO\.ORG|USO\b/i, category: "Charitable Disbursements", vendor: "USO" },
  { pattern: /BLUE\s*SKIES?\s*FOUND|GIVEBUTTER/i, category: "Charitable Disbursements", vendor: "Blue Skies Foundation" },
  { pattern: /GEORGETOWN\s*PREP/i, category: "Charitable Disbursements", vendor: "Georgetown Preparatory" },
  { pattern: /PAYPAL\s*\*\s*WWWBUDREJKO/i, category: "Charitable Disbursements", vendor: "Budrejko Memorial" },
  { pattern: /PAYPAL\s*\*\s*DUKE\s*CARRIL/i, category: "Charitable Disbursements", vendor: "Duke Carril Memorial" },
  { pattern: /PAYPAL\s*\*\s*38CHALLENGE/i, category: "Charitable Disbursements", vendor: "38 Challenge" },
  { pattern: /PAYPAL\s*\*\s*TRIBUTE2DAREN/i, category: "Charitable Disbursements", vendor: "Tribute to Daren" },

  // ── Software & Subscriptions ──
  { pattern: /TECHSOUP/i, category: "Software & Subscriptions", vendor: "TechSoup" },
  ...
  // ── Shipping & Fulfillment ──
  { pattern: /BOXUP/i, category: "Shipping & Fulfillment", vendor: "BoxUp" },
  ...
  // ── Inventory & Materials ──
  { pattern: /HARBOR\s*FREIGHT/i, category: "Inventory & Materials", vendor: "Harbor Freight" },
