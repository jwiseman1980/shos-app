...
// Legacy PAGE_TO_ROLE — everything routes to primary now
const PAGE_TO_ROLE = Object.fromEntries(
  Object.keys(PAGE_TO_COLOR).map(k => [k, "primary"])
);
...
export { CALENDARS, PAGE_TO_ROLE, PAGE_TO_COLOR };
