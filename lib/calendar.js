...
// Role calendar IDs — all owned by joseph.wiseman@steel-hearts.org
const CALENDARS = {
  primary:  "joseph.wiseman@steel-hearts.org",
  ops:      "c_8bacccb6cfa706c95402f8ecd9d762313f448b50cc0e28b0f8e8b702e8f8bbc5@group.calendar.google.com",
  cto:      "c_35b9b2903bb8b600f42b8aa3cf8dc104b5b8f1e7b51e27b189f58e08718f9d5b@group.calendar.google.com",
  ed:       "c_7548ad274c4dc142f1b9fa330549e23a9a5562142a4799ec94e3239906362102@group.calendar.google.com",
  cos:      "c_ea57d2578187145281a8024132fb6b131af5307ca82b1f9e2db401f5b5918d37@group.calendar.google.com",
  cfo:      "c_522647741b6096ecd7ceb0befd5e97522bba75bf79cf3a938cfe1d5cdc6f1c90@group.calendar.google.com",
  coo:      "c_81dda4a1f356b702578b508bfb9e265addfc6ec9a54d3e5ef8de77b2eaed2b48@group.calendar.google.com",
  comms:    "c_5f824cd418cec3b40fff693dbd1808d0cad805865712d27ecdaebdb91a29e08a@group.calendar.google.com",
  dev:      "c_15b4523b3890041635aad59f851151a49a68984538bceb574f557973cc6a54b8@group.calendar.google.com",
  family:   "c_fbc9b3f4ac97b27c4bc9e9a1341edf5252c9029e692394b4ee063f6746cc068a@group.calendar.google.com",
};

// Map SHOS app pages to their role calendar
const PAGE_TO_ROLE = {
  "/":              "ops",
  "/finance":       "cfo",
  "/finance/":      "cfo",
 ...
 * @param {string} role — one of: primary, ops, cto, ed, cos, cfo, coo, comms, dev, family
...
export async function getTodayEvents({
  ...
  if (!timeMin || !timeMax) {
    ...
    timeMin = timeMin || `${todayStr}T00:00:00`;
    timeMax = timeMax || `${todayStr}T23:59:59`;
  }
  ...
  const results = await Promise.allSettled(
    rolesToQuery.map(async (role) => {
      ...
      try {
        ...
        console.error(`[calendar] Failed to fetch ${role}:`, err.message);
        return [];
      }
    })
  );
