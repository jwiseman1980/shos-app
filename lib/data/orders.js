  ...
  try {
    ...
    const items = await sfQuery(`
      ...
      WHERE Squarespace_Order__r.Order_Type__c = 'Paid-Squarespace'
        AND Squarespace_Order__r.Order_Date__c >= ${startDate}T00:00:00.000Z
        AND Squarespace_Order__r.Order_Date__c < ${endDate}T00:00:00.000Z
    ...
    return items.map((r) => {
      ...
      const isBracelet = unitPrice === 35 || unitPrice === 45;
      ...
      return {
        ...
        obligationAmount: isBracelet ? qty * 10 : 0,
